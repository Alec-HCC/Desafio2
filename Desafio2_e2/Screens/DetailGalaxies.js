...
const DetailGalaxies = ({ route, navigation }) => {
  const { galaxy } = route.params;
  const img = {
    ...
    <View style={styles.container}>
      <ImageBackground source={img} style={styles.image}>
        ...
        <View style={styles.detailsContainer}>
          <Image source={{ uri: galaxy.galaxyImage }} style={styles.galaxyImage} />
          <Text>
            <Text style={styles.label}>Nombre: {galaxy.name}</Text>
          </Text>
          <Text>
            <Text style={styles.label}>Descripción de Galaxia: {galaxy.description}</Text>
          </Text>
        </View>
